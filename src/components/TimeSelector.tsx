...
function TimeSelector({ selected, changeTime, type }: TimeSelectorProps) {

    if (!selected) return <p>none selected</p>

    //ensure all hours are formated with 4 digits; e.g. 08:00 instead of 8:00
    ...
    return (
        <Listbox
            value={selected}
            onChange={(e) => {
                //ermove 0 in front of times < 10:00 fro database
