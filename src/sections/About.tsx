...
function About() {
  return (
    <section className='relative w-[100vw] h-fit px-4 md:px-24 p-6 flex flex-col md:flex-row items-center justify-center bg-[#1C2331]' id='about'>
      ...
      <div className="p-8 m-2 flex flex-col items-end justify-end text-right z-10">
        ...
        <button className="m-1 flex items-center h-fit border-2 border-[#FFA500] py-1 px-4 gap-[12px] text-white text-[20px] font-bold hover:scale-110 hover:bg-[#7EC699] hover:text-[#2E3A59] duration-300">
          Learn More!
        </button>
      </div>
