...
function SpecialMenu() {
  return (
    <section className="w-[100vw] px-4 md:px-24 p-6 bg-black text-white flex flex-col" id="menu">
      ...
      <div className="m-4">
        <button type="button" className="m-1 flex items-center h-fit border-2 border-[#FFA500] text-white py-1 px-4 gap-[12px] text-[20px] font-bold hover:scale-110 hover:bg-[#7EC699] hover:text-[#2E3A59] duration-300">
          View more
        </button>
      </div>
    </section>
